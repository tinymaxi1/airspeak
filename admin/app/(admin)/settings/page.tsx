...
import { Settings, Volume2, Globe, Database } from 'lucide-react';
...
export default async function SettingsPage() {
  ...
  const integrations = [
    ...
    },
    {
      name: 'ElevenLabs (TTS)',
      icon: Volume2,
      status: process.env.ELEVENLABS_API_KEY ? 'connected' : 'missing',
      detail: process.env.ELEVENLABS_API_KEY
        ? '••••••••' + process.env.ELEVENLABS_API_KEY.slice(-4)
        : 'ELEVENLABS_API_KEY env eksik',
    },
    {
